...
from foorter import genFooterTable
...
mainTable=Table([[genHeaderTable(width, heightList[0])],
...
mainTable.wrapOn(pdf,0,0) # write table on cavas
mainTable.drawOn(pdf,0,0) # write table on cavas
pdf.showPage()
